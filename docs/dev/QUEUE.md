...
| Wave | Task | Lane |
|---|---|---|
| 1 | [IE-010 — Outcome riders, and the two `on` rules made one](tasks/IE-010-outcome-riders.md) | mechanism — **passed the gate; with its builder resolving seven rebase conflicts over IE-013** |
