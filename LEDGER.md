...
| CR ≤ 5 stat-block items handed over or unapplied | 51 items | on 51 of 244 blocks | 0 | 193 blocks already clean | 0 |
...
|---|---|---|---|
| A hit whose line says more than the engine applies | 20 | 20 | Animated Rug of Smothering (CR 2) / Smother; Barbed Devil (CR 5) / Hurl Flame; Darkmantle (CR 0.5) / Crush |
...
### Handed-over lines matching no enumerated shape — 26
