...
| Wave | Task | Lane |
|---|---|---|
| 1 | [IE-010 — Outcome riders, and the two `on` rules made one](tasks/IE-010-outcome-riders.md) | mechanism — **conflicts resolved; re-review of the combination running under condition 12** |
