...
The `STATUS.md` of 2026-09-21, kept whole on the day P0-T6 capped that file at
two thousand words. Everything here was true when it was written and is not
maintained. The live file is `STATUS.md`; what happens next is
`docs/ROADMAP.md`. Do not cite this as current.
