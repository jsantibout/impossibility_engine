 ...
 * `grantSourcesOf` and `withoutGrants`, the one walk over the thirteen sourced
 ...
 *
 * The thirteen families below all carry more than this — a `Bonus`, a base Armour
...
/**
 * The thirteen families as one value, and the only place the list is written.
 *
 ...
 * has fired nine times now — for `speedModifiers`, for `attackRiders`, for
 ...
 *
 * One enumerator over the thirteen families — the bonuses Bless adds, the Armour
...
/**
 * Every grant whose source the predicate names, taken off all thirteen families.
 *
