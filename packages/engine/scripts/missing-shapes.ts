...
export const MISSING_SHAPES = {
  ...
  'a-long-casting-time':
    'CLAUDE.md: "**Casting times of 1 minute or more are refused**, and the clock did not change that ... The slot is expended on completion, and completion depends on the caster taking the Magic action every turn of the casting, which is a state machine rather than a deadline." It is the single largest blocker in the undefined population, and it blocks tracking as surely as execution.',
