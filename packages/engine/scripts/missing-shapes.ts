...
export const MISSING_SHAPES = {
  ...
  'a-casting-that-casts-another-spell':
    'CLAUDE.md, on the interrupted casting: "It is not a general interruption framework — one pending casting, no stack, and a Counterspell answering a Counterspell is refused rather than nested." A spell that casts another as part of itself, stores one to go off later, or duplicates one of a lower level needs exactly the stack that was declined.',
